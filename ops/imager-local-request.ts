...
interface CrawledPostOutputMessage {
  id: string;
  title: string;
  tags: string[];
  publishedAt: string;
  ...
  readTime: number;
  paid: boolean;
  isMediumComment: boolean;
  canonicalUrl: string;
}

const message: CrawledPostOutputMessage = {
  ...
  image: "https://bitcoinist.com/wp-content/uploads/2022/08/Picture414.png",
  siteTwitter: "@bitcoinist",
  creatorTwitter: "@bitcoinist",
  readTime: 1,
  paid: false, // todo - remove
  isMediumComment: false, // todo - remove
  canonicalUrl:
